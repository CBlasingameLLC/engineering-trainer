...
| EE 4392 Microelectronics Manufacturing I | 20 KCs across nine syllabus units; 10 generators and 158 items for the closed-form third (Deal-Grove, yield, Rayleigh, resist contrast), 34 hand-authored items for the process knowledge that has no closed form |
...
| Misconception feed | Ranked recurring errors, cross-course habit roll-up, targeted drills; 354 misconceptions in 19 families, all mapped |
